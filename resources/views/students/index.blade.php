...
<style>
    body {
        font-family: sans-serif; margin: 2rem; background-color:
        #f7fafc; 
    }
    .container { 
    ...
    .action-link {
        ...
        background-color: #4a90e2; color: white; text-decoration: none; border-
        radius: 4px; margin-bottom: 1rem;
     }
table { width: 100%; border-collapse: collapse; margin-top: 1rem; }
th, td { padding: 0.75rem; text-align: left; border-bottom: 1px
solid #e2e8f0; }
th { background-color: #edf2f7; font-weight: bold; }
.btn-edit, .btn-delete { padding: 0.25rem 0.75rem; text-decoration:
none; border-radius: 4px; color: white; }
.btn-edit { background-color: #48bb78; }
.btn-delete { background-color: #f56565; border: none; cursor:
pointer; }
</style>
</head>
<body>
<div class="container">
    <h1>Daftar Siswa</h1>
    <a href="{{ url('students/create') }}" class="action-link">Tambah
    Siswa Baru</a>
    @if(session('success'))
