...
class TeacherSeeder extends Seeder
{
    ...
    {
        $faker = Faker::create('id_ID'); // Membuat instance Faker
        for ($i = 0; $i < 10; $i++) { // Loop untuk membuat 10 data
            \DB::table('teachers')->insert([ // Menggunakan DB facade
            'nig' => $faker->unique()->randomNumber(9), // NIP
